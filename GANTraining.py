...
BATCH_SIZE = 32
GENERATE_RES = 3
IMAGE_SIZE = 128        #Edit this number to increase the resolution of generated images. Note: training time increases greatly with every increase in resolution, with a top end GPU training for 10,000 epochs at 128px took 11 hours.
IMAGE_CHANNELS = 1
SAVE_FREQ = 100
NOISE_SIZE = 100
